        ...
        <div id="carouselExampleIndicators" class="carousel slide my-4" data-ride="carousel">
          ...
          <div class="carousel-inner" role="listbox">
            <div class="carousel-item active">
              <img class="d-block img-fluid" src="slide4.jpg" alt="First slide" height="350" width="700">
            </div>
            <div class="carousel-item">
              <img class="d-block img-fluid" src="slide3.jpg" alt="Second slide" height="350">
            </div>
            <div class="carousel-item">
              <img class="d-block img-fluid" src="slide6.jpg" alt="Third slide">
            </div>
          </div>
...
<?php
$pdostat=$con->prepare("SELECT * FROM produit,categorie,appartient  WHERE produit.idproduit_PRODUIT=appartient.idproduit_PRODUIT AND appartient.numcathegorie_CATEGORIE=categorie.numcathegorie_CATEGORIE AND categorie.nom_CATEGORIE='bebe' ");
