...
<?php
$pdostat=$con->prepare("SELECT * FROM produit,categorie,appartient  WHERE produit.idproduit_PRODUIT=appartient.idproduit_PRODUIT AND appartient.numcathegorie_CATEGORIE=categorie.numcathegorie_CATEGORIE AND categorie.nom_CATEGORIE='equipement' ");
